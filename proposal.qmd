...
5.  **Hotspot and Coldspot Analysis\
    **Use Getis-Ord G-statistics to identify areas with high and low concentrations of crime.
...
7.  **Spatial Heterogeneity Analysis\
    **Explore regional differences in crime patterns using choropleth maps and box plots.
...
A Hotspot and Coldspot Analysis using Getis-Ord G-Statistics will be used to identify areas with high and low concentrations of crime. This will be displayed on a choropleth map, with hotspots having high G-statistics values and coldspots having low values.
...
Spatial Heterogeneity or Temporal Analysis will explore how crime patterns vary across different regions. This will be represented by a series of choropleth maps or box plots showing the distribution of crime rates in different regions or clusters, revealing regional differences in crime patterns.
